...
// Validate ../../app/api/retrieve/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/retrieve">> = Specific
  const handler = {} as typeof import("../../app/api/retrieve/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
